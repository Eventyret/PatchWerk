...
------------------------------------------------------------------------
ns:RegisterPatch("GatherMate2", {
    key = "GatherMate2_minimapThrottle", label = "Minimap Pin Throttle",
...
ns:RegisterPatch("GatherMate2", {
    key = "GatherMate2_rebuildGuard", label = "Stationary Rebuild Skip",
...
ns:RegisterPatch("GatherMate2", {
    key = "GatherMate2_cleuUnregister", label = "Remove Unused Combat Handler",
