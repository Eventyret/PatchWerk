...
------------------------------------------------------------------------
ns:RegisterPatch("Cell", {
    key = "Cell_debuffOrderMemo", label = "Debuff Priority Cache",
...
ns:RegisterPatch("Cell", {
    key = "Cell_customIndicatorGuard", label = "Custom Indicator Guard",
...
ns:RegisterPatch("Cell", {
    key = "Cell_debuffGlowMemo", label = "Debuff Glow Cache",
...
ns:RegisterPatch("Cell", {
    key = "Cell_inspectQueueThrottle", label = "Inspect Queue Throttle",
