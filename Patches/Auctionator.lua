...
ns:RegisterPatch("Auctionator", {
    key = "Auctionator_ownerQueryThrottle", label = "Auction Query Throttle",
...
ns:RegisterPatch("Auctionator", {
    key = "Auctionator_throttleBroadcast", label = "Timer Display Throttle",
...
ns:RegisterPatch("Auctionator", {
    key = "Auctionator_dbKeyCache", label = "Price Lookup Cache",
