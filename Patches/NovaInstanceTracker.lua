...
------------------------------------------------------------------------
ns:RegisterPatch("NovaInstanceTracker", {
    key = "NovaInstanceTracker_weeklyResetGuard", label = "Fix Login Crash",
...
ns:RegisterPatch("NovaInstanceTracker", {
    key = "NovaInstanceTracker_settingsCompat", label = "Fix Settings Menu",
