...
------------------------------------------------------------------------
ns.registry = {
    { id = "Details",            label = "Details (Damage Meter)",                  deps = { "Details" },             status = "verified",    targetVersion = "#Details.20260301.14700.170" },
    { id = "Plater",             label = "Plater (Nameplates)",                     deps = { "Plater" },              status = "verified",    targetVersion = "Plater-v633-TBC" },
    ...
    { id = "Questie",            label = "Questie (Quest Helper)",                  deps = { "Questie" },             status = "verified",    targetVersion = "11.22.0" },
    ...
    { id = "BigDebuffs",         label = "BigDebuffs (Debuff Display)",             deps = { "BigDebuffs" },          status = "verified",    targetVersion = "v60" },
    ...
    { id = "AutoLayer",          label = "AutoLayer (Layer Hopping)",               deps = { "AutoLayer_Vanilla" },   status = "verified",    targetVersion = "1.7.9" },
    { id = "AtlasLootClassic",   label = "AtlasLoot Classic (Loot Browser)",        deps = { "AtlasLootClassic" },    status = "verified",    targetVersion = "BCC 2.5.4" },
    { id = "BigWigs",            label = "BigWigs (Boss Mods)",                     deps = { "BigWigs" },             status = "verified",    targetVersion = "v407.7" },
