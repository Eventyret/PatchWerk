...
ns.registry = {
    ...
    { id = "Plater",             label = "Plater (Nameplates)",                     deps = { "Plater" },              status = "verified",    targetVersion = "Plater-v631-TBC" },
    ...
    { id = "BigWigs",            label = "BigWigs (Boss Mods)",                     deps = { "BigWigs" },             status = "verified",    targetVersion = "v406.4" },
    ...
    { id = "LeatrixPlus",        label = "Leatrix Plus (QOL)",                      deps = { "Leatrix_Plus" },        status = "verified",    targetVersion = "2.5.06" },
