...
local function BuildAddonGroup(content, groupInfo, installed)
    ...
    if ns.VERSION == "dev" and installed and ns.versionResults and ns.versionResults[groupId]
        ...
        outdatedIcon:SetScript("OnEnter", function(self)
            ...
            GameTooltip:AddLine("Patches were made for v" .. vr.expected .. ", but you now have v" .. vr.installed .. ".", 1, 1, 1, true)
            GameTooltip:AddLine("Everything should still work, but check if you notice anything odd.", 0.8, 0.8, 0.8, true)
            GameTooltip:AddLine(" ")
